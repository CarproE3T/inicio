...
if (isset($_POST['eliminar'])) {
    ...
    if ($conn->query($sql_selecciones) === TRUE) {
        ...
        if ($conn->query($sql_proyecto) === TRUE) {
            ...
            echo "<script>setTimeout(function(){ window.location.href = 'proponedor_de_proyectos.php'; }, 1000);</script>";
            exit();
        } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['eliminar'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<script>setTimeout(function(){ window.location.href = 'proponedor_de_proyectos.php'; }, 3000);</script>";
    } else {
...
<div class="container">
    ...
    <form action="editar_propuesta.php?id=<?php echo $id; ?>" method="post" onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta propuesta?');">
